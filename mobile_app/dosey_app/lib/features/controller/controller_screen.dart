...
String _commandLabel(ControllerBenchCommand command) => switch (command) {
  ...
  ControllerBenchCommand.deviceInfo => 'DEVICE_INFO',
  ControllerBenchCommand.configStatus => 'CONFIG_STATUS',
  ControllerBenchCommand.safetyStatus => 'SAFETY_STATUS',
...
String _commandTypeLabel(ControllerCommandType command) => switch (command) {
  ...
  ControllerCommandType.debugOn => 'DEBUG_ON',
  ControllerCommandType.debugOff => 'DEBUG_OFF',
